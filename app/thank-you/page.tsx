...
// Remove this import if lib/analytics.ts does not exist
import { trackEvent } from "@/lib/analytics";

export default function ThankYouPage() {
  useEffect(() => {
    // Remove this block if you don't have lib/analytics.ts
      ...
      <div className="mx-auto max-w-4xl px-6">
        <div className="rounded-3xl border border-slate-200 bg-white p-10 shadow-2xl lg:p-16">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-center text-xl leading-9 text-slate-600">
            ...
            Our team will review your information and contact you within one
            business day.
          </p>
          ...
          <div className="mt-14 rounded-2xl bg-blue-50 p-8">
            ...
            <div className="mt-8 space-y-5">
              ...
              <div className="flex gap-4">
                <CheckCircle2 className="mt-1 text-blue-600" size={22} />
                <p className="text-slate-700">
                  We'll prepare a personalized growth strategy tailored to your
                  business.
                </p>
              </div>
              ...
              <div className="flex gap-4">
                <CheckCircle2 className="mt-1 text-blue-600" size={22} />
                <p className="text-slate-700">
                  You'll receive practical recommendations to help grow your
                  business.
                </p>
              </div>
            </div>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-3 text-slate-600">
                Learn more about websites, SEO, AI automation and digital
                marketing.
              </p>
            </Link>
            ...
            >
              ...
              <p className="mt-3 text-slate-600">
                Explore our latest digital marketing and website development
                projects.
              </p>
            </Link>
            ...
            >
              ...
              <p className="mt-3 text-slate-600">
                Need to update your request? Reach out to our team anytime.
              </p>
            </Link>
          </div>
          ...
          <div className="mt-12 rounded-2xl border border-blue-200 bg-blue-50 p-6 text-center">
            ...
            <p className="mt-3 text-slate-600">
              ...
              business day, please check your spam folder or contact us
              directly.
            </p>
          </div>
        </div>
