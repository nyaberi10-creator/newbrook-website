...
export default function ContactHero({
  ...
  description = "Whether you're looking for a high-converting website, paid advertising, Klaviyo lifecycle marketing, AI automation or complete growth strategy, we're ready to help.",
